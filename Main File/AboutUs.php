                ...
                <table class="producttab">
                    <tr>
                        ...
                        <td  valign="middle" class="aboutus-text">
                            ...
                            <!-- <hr> -->
                            <div class="Descript">
                                <h2>Our Company is a start up company to promote Myanmar Tradtitonal goods. These goods include Lacquerware, Bamboo Crafts and Jewelery and others.</h2>
