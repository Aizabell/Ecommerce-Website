    ...
    <div class="container">
        ...
        <section class="sectpage welcome">
            <div class="welcome-text">
                ...
                <h3>Bringing Myanmar Traditions To Your Door</h3>
        ...
        <section class="sectpage rflex">
            ...
            <div class="feature-sect">
                <div class="feature-box">
                    <div class="product">
                        <div class="prodimg">
                            <img src="../Images/Products/LQW4.jpg" alt="1">
                            <div class="overlayduct">
                        ...
                        <div class="catebox">
                            <div class="catetail">
                                <a href="Products.php">Lacquerware</a>
                            </div>
                ...
                <div class="feature-box">
                    <div class="product">
                        <div class="prodimg">
                            <img src="../Images/Products/BC4.jpg" alt="1">
                            <div class="overlayduct">
                                <a href="Products.php" class="seemore-btn">See more</a>
                            </div>
                        </div>
                        <div class="catebox">
                            <div class="catetail">
                                <a href="Products.php">Bamboo Crafts</a>
                            </div>
                ...
                <div class="feature-box">
                    <div class="product">
                        <div class="prodimg">
                            <img src="../Images/Products/GEM2.jpg" alt="1">
                            <div class="overlayduct">
                                <a href="Products.php" class="seemore-btn">See more</a>
                            </div>
                        </div>
                        <div class="catebox">
                            <div class="catetail">
                                <a href="Handbag.html">Jewelery</a>
                            </div>
