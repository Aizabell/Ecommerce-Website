    ...
    <div class="container">
        ...
        <section class="flexpage rflex">
            <div class="cat-title2">
                ...
                <hr class="titlines">
                <a href="Payment.php" class="Pagetitle ">
                    <h2>PAYMENT</h2>
                </a>
                <hr class="titlines">
                <a href="CheckOut.php" class="Pagetitle selected">
                    <h2>CHECKOUT</h2>
                </a>
            </div>
            <!-- <hr class="titline"> -->
                ...
                <table class="producttab" cellspacing="0">
                    <tr border-right=" 1px solid #000000;">
                        ...
                        <td class="imagetab2 rightside" valign="middle">
                            <div class="slideshow-container extrap">
                                <div class="  imgfixing">
                                    <h3>&nbsp</h3><br>
                                    <h3>&nbsp</h3>
                                </div>
                                ...
                                <form action="AddNewOrder.php" method="POST">
                                    <div class="  imgfixing">
                                        <h3>&nbsp</h3>
                                        <button type="submit" class="path-btn">Confirm Order</button>
                                    </div>
                                </form>
