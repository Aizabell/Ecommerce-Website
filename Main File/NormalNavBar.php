...
<body>
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="Products.php">Lacquerware</a></li>
                        <li><a href="Products.php">Bamboo Craft</a></li>
                        <li><a href="Products.php">Jewelery</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#">Explore</a>
                        ...
                        <?php if ($_SESSION['role'] == 'admin') : ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="AOrder.php">MANAGE ORDERS</a></li>
                                    <li><a href="AProduct.php">MANAGE PRODUCTS</a></li>
                                </ul>
                            </li>
    ...
    <div class="popup" id="signin-popup" style="display: none;">
        <div class="popup-content form-container">
            ...
            <!-- signup form -->
            <form id="signup-form" action="SignUp.php" class="tabcontent" action="" method="POST">
                <div class="form-group">
